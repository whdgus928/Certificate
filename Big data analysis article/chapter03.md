...
#### 텍스트 전처리
1. 토근화: 텍스트 문서의 모든 문장을 개별 단위로 쪼개는 과정, 공백 및 구두점 제거
2. stopwords 제거: 문서에서 빈번하게 사용되어 검색에서 무시해 버리는 문자열, 전치사 관사 접속사
3. 어간추출: 간다 갔다 가니 -> 가다 로 통일
4. bag of words: 문서를 숫자 벡터로 변환

#### 텍스트 정형화


### (7) 앙상블 분석: 여러 개의 분류 모형에 결과를 종합해 설명력 높임
- 과대적합 감소 효과
...
### (8) 비모수 통계: 모집단의 분포하에 대해 모수형의 가정을 하지 않는 통계방법
